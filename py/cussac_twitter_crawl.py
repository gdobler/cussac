...
#    tso.setUntil(dt.date(2014, 03, 24))
    ...
    while True:
        ...
        text_file = open('/home/anjaney/twitter/output/json_tweets'+str(t)+'.txt', "a")
	text_fileE = open('/home/anjaney/twitter/output/error_log.txt', "a")
...
#            print tweet_id,t
	...
	print len(records)
     ...
     twitterFrame = pd.DataFrame.from_records(records,columns=['Tweet ID',"Tweeted_At",'Profile_Create_at','Username','Location','Enabled','Place','Geo','Text'])
     print "Created DataFrame",len(twitterFrame)
     twitterFrame.to_csv('/home/anjaney/twitter/output/csv_tweets'+str(t)+'.csv')
